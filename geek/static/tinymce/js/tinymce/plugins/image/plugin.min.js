    ...
    function i(r) {
        ...
        function o() {
            function t(t) {
                ...
                t.onload = function () {
                    y.width || y.height || !x || b.setAttribs(t, {width: t.clientWidth, height: t.clientHeight}), n()
                }, t.onerror = n
            }
            ...
            c(), i(), y = tinymce.extend(y, d.toJSON()), y.alt || (y.alt = ""), y.title || (y.title = ""), "" === y.width && (y.width = null), "" === y.height && (y.height = null), y.style || (y.style = null), y = {
                ...
                if ("" === y.title && (y.title = null), f ? b.setAttribs(f, y) : (y.id = "__mcenew", e.focus(), e.selection.setContent(b.createHTML("img", y)), f = b.get("__mcenew"), b.setAttrib(f, "id", null)), e.editorUpload.uploadImagesAuto(), y.caption === !1 && b.is(f.parentNode, "figure.image") && (n = f.parentNode, b.insertAfter(f, n), b.remove(n)), y.caption !== !0)t(f); else if (!b.is(f.parentNode, "figure.image")) {
                    r = f, f = f.cloneNode(!0), n = b.create("figure", {"class": "image"}), n.appendChild(f), n.appendChild(b.create("figcaption", {contentEditable: !0}, "Caption")), n.contentEditable = !1;
        ...
        function c() {
            ...
            if (e.settings.image_advtab) {
                var n = d.toJSON(), r = b.parseStyle(n.style);
        ...
        function u() {
            if (e.settings.image_advtab) {
                var t = d.toJSON(), n = b.parseStyle(t.style);
        ...
        var d, f, h, m, p, g, v, y = {}, b = e.dom, x = e.settings.image_dimensions !== !1;
        ...
        var C = [{name: "src", type: "filepicker", filetype: "image", label: "Source", autofocus: !0, onchange: s}, g];
        e.settings.image_description !== !1 && C.push({
            ...
            data: y,
            bodyType: "tabpanel",
            body: [{title: "General", type: "form", items: C}, {
                title: "Advanced",
                type: "form",
                pack: "start",
                items: [{label: "Style", name: "style", type: "textbox", onchange: u}, {
                    type: "form",
                    layout: "grid",
                    packV: "start",
                    columns: 2,
            ...
            onSubmit: o
        })) : d = e.windowManager.open({title: "Insert/edit image", data: y, body: C, onSubmit: o})
    }
